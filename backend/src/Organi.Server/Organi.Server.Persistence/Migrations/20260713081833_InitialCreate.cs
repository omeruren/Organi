        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Category_DisplayOrder", "[DisplayOrder] >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Coupon_Dates", "[EndDate] > [StartDate]");
                    table.CheckConstraint("CK_Coupon_DiscountValue", "[DiscountValue] > 0");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Product_SalePrice", "[SalePrice] IS NULL OR [SalePrice] < [Price]");
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("20000000-0000-0000-0000-000000000001"), new DateTime(2026, 7, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Create new products", "Products", "Products.Create", null, null },
                    { new Guid("20000000-0000-0000-0000-000000000002"), new DateTime(2026, 7, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "View product information", "Products", "Products.Read", null, null },
                    { new Guid("20000000-0000-0000-0000-000000000003"), new DateTime(2026, 7, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Update product information", "Products", "Products.Update", null, null },
                    { new Guid("20000000-0000-0000-0000-000000000004"), new DateTime(2026, 7, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Delete products", "Products", "Products.Delete", null, null },
                    { new Guid("20000000-0000-0000-0000-000000000005"), new DateTime(2026, 7, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Create orders", "Orders", "Orders.Create", null, null },
                    { new Guid("20000000-0000-0000-0000-000000000006"), new DateTime(2026, 7, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "View orders", "Orders", "Orders.Read", null, null },
                    { new Guid("20000000-0000-0000-0000-000000000007"), new DateTime(2026, 7, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Update order status", "Orders", "Orders.Update", null, null },
                    { new Guid("20000000-0000-0000-0000-000000000008"), new DateTime(2026, 7, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Cancel orders", "Orders", "Orders.Cancel", null, null },
                    { new Guid("20000000-0000-0000-0000-000000000009"), new DateTime(2026, 7, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Manage categories", "Categories", "Categories.Manage", null, null },
                    { new Guid("20000000-0000-0000-0000-000000000010"), new DateTime(2026, 7, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "View vendor information", "Vendors", "Vendors.Read", null, null },
                    { new Guid("20000000-0000-0000-0000-000000000011"), new DateTime(2026, 7, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Manage vendor accounts", "Vendors", "Vendors.Manage", null, null },
                    { new Guid("20000000-0000-0000-0000-000000000012"), new DateTime(2026, 7, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "View user information", "Users", "Users.Read", null, null },
                    { new Guid("20000000-0000-0000-0000-000000000013"), new DateTime(2026, 7, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Manage user accounts", "Users", "Users.Manage", null, null },
                    { new Guid("20000000-0000-0000-0000-000000000014"), new DateTime(2026, 7, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Manage coupons", "Coupons", "Coupons.Manage", null, null },
                    { new Guid("20000000-0000-0000-0000-000000000015"), new DateTime(2026, 7, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Manage reviews", "Reviews", "Reviews.Manage", null, null },
                    { new Guid("20000000-0000-0000-0000-000000000016"), new DateTime(2026, 7, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Create blog posts", "Blog", "Blog.Create", null, null },
                    { new Guid("20000000-0000-0000-0000-000000000017"), new DateTime(2026, 7, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Manage all blog posts", "Blog", "Blog.Manage", null, null },
                    { new Guid("20000000-0000-0000-0000-000000000018"), new DateTime(2026, 7, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "View system reports", "Reports", "Reports.View", null, null },
                    { new Guid("20000000-0000-0000-0000-000000000019"), new DateTime(2026, 7, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "View audit logs", "AuditLogs", "AuditLogs.View", null, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("10000000-0000-0000-0000-000000000001"), new DateTime(2026, 7, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Full system access", true, "Admin", null, null },
                    { new Guid("10000000-0000-0000-0000-000000000002"), new DateTime(2026, 7, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Vendor operations and product management", true, "Vendor", null, null },
                    { new Guid("10000000-0000-0000-0000-000000000003"), new DateTime(2026, 7, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Standard customer access", true, "Customer", null, null }
                });
